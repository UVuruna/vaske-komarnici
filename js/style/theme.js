...
export async function settingTheme(currentTheme) {
    ...
    await Promise.all(
        [
            // ----------> Set Color LOGO & MENU <----------
            colorizeSVG(LOGO, PresetColors.primaryElement, PresetColors.secondaryElement),
            colorizeSVG(MENU, PresetColors.primaryElement, PresetColors.secondaryElement),
            // ----------> Hover effect LOGO & MENU <----------
            colorChange(LOGO, PresetColors.primaryElement, PresetColors.secondaryElement, colorizeSVG),
            colorChange(MENU, PresetColors.primaryElement, PresetColors.secondaryElement, colorizeSVG),
            ...
            coloredTextStyle(document.querySelectorAll('li strong,  .categoryText'), hoverTxtColor, PresetColors, currentTheme),
            // ----------> Navigation Dropdown Menu <----------
            menuStyle(document.querySelectorAll('#header ul'), PresetColors.primary, PresetColors.primaryElement, hoverBgColor),
            // ----------> Table & Form <----------
