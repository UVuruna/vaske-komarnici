...
<div id="about_us" class="light">
  ...
  <section>
    ...
    <ul>
      ...
      <li><a href="<?php echo $basePath ?>katalog/plise-komarnici/"><strong>Plise (harmonika)</strong></a> – Savršeni za vrata i prozore većih dimenzija.</li>
    </ul>
  </section>
  ...
  <section>
    ...
    <p>Naši komarnici su dostupni u različitim bojama i dimenzijama, a takođe nudimo i mogućnost <strong>izrade po meri</strong>.</p>
    <p>Naš tim stručnjaka će vam pomoći da odaberete <strong>najbolju opciju</strong> za vaše potrebe i prostor.</p>
  </section>
  ...
  <section>
    ...
    <ul>
      ...
      <li><strong>Popravke kanapa</strong> – Zamena istrošenih ili pokidanih kanapa sa visokokvalitetnim materijalima za dugotrajan rad.</li>
      <li><strong>Zamena mreže</strong> – Ugradnja novih mreža za komarnike u različitim bojama i vrstama, uključujući fiberglass i teflonske mreže.</li>
      <li><strong>Popravka rolo i plisa komarnika</strong> – Ako su vaši rolo ili plisa komarnici oštećeni, naš tim će ih brzo i efikasno popraviti.</li>
    </ul>
    <p>Naša usluga uključuje <strong>brzu dijagnostiku</strong> i <strong>povoljnu cenu popravki</strong>, kako biste ponovo uživali u komarnicima koji rade kao novi.</p>
  </section>
