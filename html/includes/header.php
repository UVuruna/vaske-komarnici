        ...
        <ul id="navigationMenu" class="menu navigation" role="menubar">
            ...
            <li class="dropdownTrigger" role="menuitem">
                ...
                <ul id="komarnici-navigation" class="navigation" role="menu">
                    <li role="menuitem"><a href="<?php echo $basePath ?>katalog/fiksni-komarnici" title="Fiksni komarnici">Fiksni</a></li>
                    <li role="menuitem"><a href="<?php echo $basePath ?>katalog/rolo-komarnici" title="Rolo komarnici">Rolo</a></li>
                    <li role="menuitem"><a href="<?php echo $basePath ?>katalog/plise-komarnici" title="Plise komarnici">Plise</a></li>
                </ul>
            </li>
            <li role="menuitem"><a href="<?php echo $basePath ?>o_nama" title="O nama">O nama</a></li>
            <li role="menuitem"><a href="<?php echo $basePath ?>katalog/" title="Kompletan katalog">Katalog</a></li>
            <li class="pulse" role="menuitem"><a href="<?php echo $basePath ?>kontakt/" title="Poručite komarnike odmah">Poručite Odmah</a></li>
        </ul>
